...
This repository contains code discussed in class, and will be continuously updated throughout the semester. 
...
```bash
git clone https://github.com/nyu-popl-sp26/in-class-code.git
```
...
** Make sure to give your system plenty of disk space; at least 30 GB, if possible. VirtualBox will only actually use what it needs.
